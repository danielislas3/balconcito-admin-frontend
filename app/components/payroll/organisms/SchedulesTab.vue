  ...
  <div class="space-y-6">
    ...
    <UCard v-if="!currentEmployee"
      ...
      <div class="py-12 text-center space-y-4">
        ...
        <h3 class="text-xl font-bold">No hay empleado seleccionado</h3>
        <p class="text-muted max-w-md mx-auto">Selecciona un empleado existente o crea uno
          nuevo para comenzar.</p>
        <UButton label="Agregar Primer Empleado" icon="i-lucide-user-plus" color="primary" size="lg"
    ...
    <UCard v-else-if="!currentWeek"
      ...
      <div class="py-12 text-center space-y-4">
        ...
        <h3 class="text-xl font-bold">No hay semana seleccionada</h3>
        <p class="text-muted max-w-md mx-auto">Selecciona una semana existente o crea una nueva
          para {{ currentEmployee.name }}.</p>
        <UButton label="Crear Nueva Semana" icon="i-lucide-calendar-plus" color="primary" size="lg"
