...
export const usePayrollStore = defineStore('payroll', () => {
  ...
  async function fetchEmployees() {
    ...
    try {
      ...
      error.value = (err instanceof Error ? err.message : undefined) || 'Error al cargar empleados'
  ...
  async function createEmployee(
    ...
    try {
      ...
      error.value = (err instanceof Error ? err.message : undefined) || 'Error al crear empleado'
  ...
  async function updateEmployeeSettings(
    ...
    try {
      ...
      error.value = (err instanceof Error ? err.message : undefined) || 'Error al actualizar configuración'
      return { success: false, error: error.value }
    } finally {
      loading.value = false
    }
  ...
  async function deleteCurrentEmployee(): Promise<{ success: boolean, error?: string }> {
    ...
    try {
      ...
      error.value = (err instanceof Error ? err.message : undefined) || 'Error al eliminar empleado'
      return { success: false, error: error.value }
    } finally {
      loading.value = false
    }
  ...
  async function createWeek(
    ...
    try {
      ...
      error.value = (err instanceof Error ? err.message : undefined) || 'Error al crear semana'
      return { success: false, error: error.value }
    } finally {
      loading.value = false
    }
  ...
  async function updateDaySchedule(
    ...
    try {
      ...
      error.value = (err instanceof Error ? err.message : undefined) || 'Error al actualizar horario'
      return { success: false, error: error.value }
    } finally {
      loading.value = false
    }
  ...
  async function updateWeeklyTips(tips: number): Promise<{ success: boolean, error?: string }> {
    ...
    try {
      ...
      error.value = (err instanceof Error ? err.message : undefined) || 'Error al actualizar propinas'
      return { success: false, error: error.value }
    } finally {
      loading.value = false
    }
  ...
  async function updateShiftRate(shiftRate: number | null): Promise<{ success: boolean, error?: string }> {
    ...
    try {
      ...
      error.value = (err instanceof Error ? err.message : undefined) || 'Error al actualizar tarifa por turno'
      return { success: false, error: error.value }
    } finally {
      loading.value = false
    }
  ...
  async function deleteCurrentWeek(): Promise<{ success: boolean, error?: string }> {
    ...
    try {
      ...
      error.value = (err instanceof Error ? err.message : undefined) || 'Error al eliminar semana'
      return { success: false, error: error.value }
    } finally {
      loading.value = false
    }
